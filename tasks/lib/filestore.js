                ...
                function (fnCallbackAsyncL2) {
                    ...
                    async.whilst(
                        ...
                        function (fnCallbackAsyncL3) {
                            ...
                            var oRequest = unirest.get(me._constructBaseUrl() + '/' + sFolder + '/content');
                        ...
                        function (oError, oResult) {
                            aArtifactsServer = aArtifactsServer.map(function (oItem) {
                                var aValues = (oItem.id).split(SLASH_ESCAPED);
                                aValues.shift(); // remove bsp container name at the beginning
